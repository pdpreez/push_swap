...
#    Updated: 2018/07/02 17:01:32 by ppreez           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
		...
		ft_strtrim.c ft_tolower.c ft_toupper.c ft_lstnew.c ft_lstadd.c \
		ft_lstdelone.c ft_lstdel.c ft_lstiter.c ft_lstmap.c ft_wordcount.c \
		ft_strrev.c ft_strndup.c get_next_line.c ft_debug.c ft_lstaddend.c
...
$(OBJS): $(FILES)
	gcc -c -I. $(FILES) -Wall -Wextra -Werror
